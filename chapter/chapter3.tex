...
\begin{itemize}
    ...
    \item consistenza
    \item persistenza(durability): l'efficienza di Redis é dovuta in buona parte al suo modo di gestire questa proprietá: infatti vi é la possibilitá
    di scegliere tra diversi meccanismi, offrendo l'opportunitá di salvare database totalmente su disco, oppure di funzionare esclusivamente come una
    memoria cache. I meccanismi, che verranno illustrati di seguito, sono:
      \begin{itemize}
          \item \emph{RDB}
          \item \emph{AOF}
          \item \emph{Database in Memory}
