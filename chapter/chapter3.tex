...
EXEC\end{lstlisting}
    ...
    piú presente.\\
    Quindi questo é un modo efficace per ottenere un buon livello di isolamento.
...
Background saving started by pid 68751
...
\begin{itemize}
    ...
    \item \textbf{Chat, messaggistica e code}: grazie alle strutture dati che offre, come i set e le hash, e strutture dati aggiuntive come pub/sub
    (in cui vi é un publisher e piú subscriber) puó essere utilizzato per la messaggistica. Infatti vengono offerte prestazioni elevate per
