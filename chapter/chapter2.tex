...
un insieme d'istanze di una certa classe, ed un \texttt{blocco} é l'istanza di quella classe.
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Confronto tra modellazione Relazione e modellazione NoSQL}
\end{figure}
