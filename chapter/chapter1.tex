...
\begin{itemize}
    ...
    \item \textbf{Standard universale}: ogni database ha il proprio metodo di storing ed accesso ai dati, in quanto vi é una mancanza di uno standard
    ...
    \item \textbf{Espressivitá}: problema legato ai linguaggi di interrogazione, infatti risulta essere meno espressivo rispetto al SQL nella grande maggioranza dei
